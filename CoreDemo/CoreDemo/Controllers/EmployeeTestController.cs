...
namespace CoreDemo.Controllers
{
    public class EmployeeTestController : Controller
    {
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessae = await httpClient.GetAsync("https://localhost:44328/api/Default");
            var jsonString = await responseMessae.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> AddEmployee(Class1 p)
        {
            ...
            var responseMessage = await htppClient.PostAsync("https://localhost:44328/api/Default", content);
